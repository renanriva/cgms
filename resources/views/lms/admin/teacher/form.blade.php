                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="form-group has-warning">
                                    <span class="help-block"> <i class="fa fa-caret-left"></i> This email will be used as login email address.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="js-edit-canton-name" class="col-md-3 control-label">Photo</label>
                                    <div class="col-md-9">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="dost_code" class="col-md-3 control-label">District Code</label>
                                    <div class="col-md-9">
